# =============================================================================
# TENANT: GCPE Media Monitoring
# =============================================================================
# PROD environment configuration for GCPE Media Monitoring.
# =============================================================================

tenant = {
  tenant_name  = "gcpe-media-monitoring"
  ...
  user_management = {
    seed_members = {
      admin = [
        "jeremy.burbee@gov.bc.ca",
        "alessia.yanchen@gov.bc.ca"
      ]
    }
  }
