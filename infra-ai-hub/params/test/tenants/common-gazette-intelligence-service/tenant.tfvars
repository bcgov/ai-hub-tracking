# =============================================================================
# TENANT: Common Gazette Intelligence Service - TEST ENVIRONMENT
# =============================================================================
# TEST environment configuration for Common Gazette Intelligence Service.
# =============================================================================

tenant = {
  tenant_name  = "common-gazette-intelligence-service"
  display_name = "Common Gazette Intelligence Service"
  enabled      = true
  ...
  tags = {
    ministry    = "MOTI"
    environment = "test"
    department  = "Properties and Land Management Branch"
  }
  ...
  user_management = {
    seed_members = {
      admin = [
        "raghu.mohindru@gov.bc.ca",
        "sukhbir.gill@gov.bc.ca"
      ]
    }
  }
