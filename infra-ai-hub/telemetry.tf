# ============================================================================
# Azure Verified Module (AVM) Telemetry
# ============================================================================
# This file contains all telemetry-related resources for Azure Verified Modules.
# Telemetry helps track module usage and improvements. Can be disabled by 
...
locals {
  # Detect if this is a fork of an official Azure module
  ...
  # Valid module source patterns for official Azure modules
  ...
  # Build AVM headers for API calls
